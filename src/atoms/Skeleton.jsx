    ...
    <>
    {
      Array.from({length:3}).map((e,i) =>(
            ...
            <div className="avatar-parent flex items-center mt-4">
                  <svg className=" avatar w-10 h-10 me-3 text-gray-200 dark:text-gray-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
